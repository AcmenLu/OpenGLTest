...
//
//	lightshader->SetFloat( "ambientStrength", 0.9f );
//	lightshader->SetVector3( "ambientLightColor", 1.0f, 0.5f, 0.31f );
//
//	lightshader->SetVector3( "diffuseLightPos", 1.2f, 1.0f, 2.0f);
//	lightshader->SetVector3( "diffuseLightColor", 1.0f, 1.0f, 1.0f);
//	lightshader->SetVector3( "objectColor", 1.0f, 0.5f, 0.31f );
//
//	lightshader->SetFloat( "specularStrength", 0.9f );
...
//
//	lightshader = new Shader("./Shader/Light/Light/specularlightsample.vs", "./Shader/Light/Light/specularlightsample.fs");
//
